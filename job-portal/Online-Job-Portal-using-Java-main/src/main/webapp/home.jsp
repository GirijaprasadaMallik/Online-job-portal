                ...
                <div class="card bg-dark text-white">
                    <div class="card-body">
                        <form class="form-inline" action="more_view.jsp" method="get">
                            <div class="form-group col-md-5 mt-1 d-inline">
                            ...
                            <div class="form-group col-md-5 mt-1 ml-5 d-inline">
                                <div style="width:10px; display: inline-block;"></div>
                                <h4 style="display: inline;" class="ml-5 text-white">Category</h4>
                            </div>

                            <div class="form-group col-md-5 d-inline">
                                <select class="custom-select bg-light text-dark border border-dark" name="cat">
